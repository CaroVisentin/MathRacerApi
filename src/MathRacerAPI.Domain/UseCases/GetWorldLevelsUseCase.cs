...
namespace MathRacerAPI.Domain.UseCases
{
    ...
    public class GetWorldLevelsUseCase
    {
        ...
        private async Task<PlayerWorldLevels> GetLevelsForPlayer(PlayerProfile player, int worldId)
        {
            ...
            // 2. Obtener el ID del mundo actual del jugador según su último nivel completado
            var playerCurrentWorldId = await _worldRepository.GetWorldIdByLevelIdAsync(player.LastLevelId);

            // 3. Validar que el jugador tenga acceso al mundo solicitado
            ...
            // 4. Obtener todos los mundos para validar que el worldId existe
            ...
            // 5. Obtener todos los niveles del mundo

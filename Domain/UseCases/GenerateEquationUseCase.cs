...
{
    public class GenerateEquationUseCase
    {
        private readonly Random _rand = new();

        public async Task<Equation> ExecuteAsync(EquationParams p)
        {
            ValidateParams(p);
            ...
            var equationReturn = new Equation
            {
            ...
            return await Task.FromResult(equationReturn);
        }
